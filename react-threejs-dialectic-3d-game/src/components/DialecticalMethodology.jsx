...
const concepts = [
  ...
  },
  {
    ...
    content: [
      {
        type: "example",
        title: "Ví dụ về bàn tay",
        points: [
          "Điểm chung: đều là ngón tay, đều có đốt, đều giúp chúng ta cầm nắm",
          "Cái riêng: Mỗi ngón tay lại có tên và độ dài khác nhau",
          "Cái đơn nhất: Trên bàn tay của một người, có một ngón tay có vết sẹo/nốt ruồi riêng do tai nạn, hoặc một hình dạng móng tay khác thường mà các ngón khác không có",
        ],
      },
    ],
  },
